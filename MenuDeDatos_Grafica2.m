function varargout = MenuDeDatos_Grafica2(varargin)
% MENUDEDATOS_GRAFICA2 MATLAB code for MenuDeDatos_Grafica2.fig
%      MENUDEDATOS_GRAFICA2, by itself, creates a new MENUDEDATOS_GRAFICA2 or raises the existing
%      singleton*.
%
%      H = MENUDEDATOS_GRAFICA2 returns the handle to a new MENUDEDATOS_GRAFICA2 or the handle to
%      the existing singleton*.
%
%      MENUDEDATOS_GRAFICA2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MENUDEDATOS_GRAFICA2.M with the given input arguments.
%
%      MENUDEDATOS_GRAFICA2('Property','Value',...) creates a new MENUDEDATOS_GRAFICA2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MenuDeDatos_Grafica2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MenuDeDatos_Grafica2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MenuDeDatos_Grafica2

% Last Modified by GUIDE v2.5 07-Apr-2017 23:28:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MenuDeDatos_Grafica2_OpeningFcn, ...
                   'gui_OutputFcn',  @MenuDeDatos_Grafica2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MenuDeDatos_Grafica2 is made visible.
function MenuDeDatos_Grafica2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MenuDeDatos_Grafica2 (see VARARGIN)

% Choose default command line output for MenuDeDatos_Grafica2
...
% UIWAIT makes MenuDeDatos_Grafica2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MenuDeDatos_Grafica2_OutputFcn(hObject, eventdata, handles) 
...
for n=1:nf
    an=0;
    bn=(A1/(n*pi))*((-cos(((2*n*pi)/t2)*t1))+(cos((2*n*pi)*t1)));
