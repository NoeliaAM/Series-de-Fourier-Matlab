                                                 function varargout = MenuDeDatos_Grafica4(varargin)
% MENUDEDATOS_GRAFICA4 MATLAB code for MenuDeDatos_Grafica4.fig
%      MENUDEDATOS_GRAFICA4, by itself, creates a new MENUDEDATOS_GRAFICA4 or raises the existing
%      singleton*.
%
%      H = MENUDEDATOS_GRAFICA4 returns the handle to a new MENUDEDATOS_GRAFICA4 or the handle to
%      the existing singleton*.
%
%      MENUDEDATOS_GRAFICA4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MENUDEDATOS_GRAFICA4.M with the given input arguments.
%
%      MENUDEDATOS_GRAFICA4('Property','Value',...) creates a new MENUDEDATOS_GRAFICA4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MenuDeDatos_Grafica4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MenuDeDatos_Grafica4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MenuDeDatos_Grafica4

% Last Modified by GUIDE v2.5 09-Apr-2017 03:26:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MenuDeDatos_Grafica4_OpeningFcn, ...
                   'gui_OutputFcn',  @MenuDeDatos_Grafica4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MenuDeDatos_Grafica4 is made visible.
function MenuDeDatos_Grafica4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MenuDeDatos_Grafica4 (see VARARGIN)

% Choose default command line output for MenuDeDatos_Grafica4
...
% UIWAIT makes MenuDeDatos_Grafica4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MenuDeDatos_Grafica4_OutputFcn(hObject, eventdata, handles) 
...
for n=1:nf
    an=0;
    bn=( ((4*A1)/(n*pi))*((2/(n*pi)) * sin ((n*pi)/2) - (n*pi*sin(n*pi))));
