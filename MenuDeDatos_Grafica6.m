function varargout = MenuDeDatos_Grafica6(varargin)
% MENUDEDATOS_GRAFICA6 MATLAB code for MenuDeDatos_Grafica6.fig
%      MENUDEDATOS_GRAFICA6, by itself, creates a new MENUDEDATOS_GRAFICA6 or raises the existing
%      singleton*.
%
%      H = MENUDEDATOS_GRAFICA6 returns the handle to a new MENUDEDATOS_GRAFICA6 or the handle to
%      the existing singleton*.
%
%      MENUDEDATOS_GRAFICA6('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MENUDEDATOS_GRAFICA6.M with the given input arguments.
%
%      MENUDEDATOS_GRAFICA6('Property','Value',...) creates a new MENUDEDATOS_GRAFICA6 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MenuDeDatos_Grafica6_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MenuDeDatos_Grafica6_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MenuDeDatos_Grafica6

% Last Modified by GUIDE v2.5 09-Apr-2017 04:56:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MenuDeDatos_Grafica6_OpeningFcn, ...
                   'gui_OutputFcn',  @MenuDeDatos_Grafica6_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MenuDeDatos_Grafica6 is made visible.
function MenuDeDatos_Grafica6_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MenuDeDatos_Grafica6 (see VARARGIN)

% Choose default command line output for MenuDeDatos_Grafica6
...
% UIWAIT makes MenuDeDatos_Grafica6 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MenuDeDatos_Grafica6_OutputFcn(hObject, eventdata, handles) 
...
for n=1:nf
    an = 0;
    bn = ((-2*A1)/(n*pi))*(cos(n*pi)+((n*pi)*sin(n*pi)));
